...
<html lang="en">
  <head>
    ...
    <link href="{{url('https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700,800,900" rel="stylesheet')}}">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="hotel-resto.html" class="nav-link">Hotels &amp; Restaurant</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 mb-5 text-center">
            <h1 class="mb-3 bread">Hotels &amp; Guest house</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Hotel &amp; Restaurant <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
		        		...
		        		<div class="row">
		        			<div class="col-lg align-items-end">
		        				<div class="form-group">
		        					<label for="#">Hotel &amp; Restaurant</label>
		          				<div class="form-field">
		          					<div class="icon"><span class="ion-ios-search"></span></div>
				                <input type="text" class="form-control" placeholder="Hotel &amp; Restaurant">
				              </div>
			              </div>
		        			</div>
		        			<div class="col-lg align-items-end">
    	...
    	<div class="container">
		 ...
		 <!--change-->					
    			...
    			<div class="col-md-6 col-lg-4 ftco-animate">
    				<div class="project">
    					<div class="img">
		    				<img src="images/hotel-resto-5.jpg" class="img-fluid" alt="Colorlib Template">
	    				</div>
	    				<div class="text">
		 ...
		 <!--change-->					
	    				...
	    				<a href="images/hotel-resto-5.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="icon-expand"></span>
	    				</a>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-4 ftco-animate">
    				<div class="project">
    					<div class="img">
		    				<img src="images/f22.jpg" class="img-fluid" alt="Colorlib Template">
	    				</div>
	    				<div class="text">
		 ...
		 <!--change-->					
	    				...
	    				<a href="images/f22.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="icon-expand"></span>
	    				</a>
    				</div>
    			</div>
		 ...
		 <!--change-->					
    			...
    			<div class="col-md-6 col-lg-4 ftco-animate">
    				<div class="project">
    					<div class="img">
		    				<img src="images/f32.jpg" class="img-fluid" alt="Colorlib Template">
	    				</div>
	    				<div class="text">
		 ...
		 <!--change-->					
	    				...
	    				<a href="images/f32.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="icon-expand"></span>
	    				</a>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-4 ftco-animate">
    				<div class="project">
    					<div class="img">
		    				<img src="images/f33.jpg" class="img-fluid" alt="Colorlib Template">
	    				</div>
	    				<div class="text">
			...
			<!-- -->
	    				...
	    				<a href="images/f33.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="icon-expand"></span>
	    				</a>
    				</div>
    			</div>
               ...
               <!--change-->
    			...
    			<div class="col-md-6 col-lg-4 ftco-animate">
    				<div class="project">
    					<div class="img">
		    				<img src="images/h32.jpg" class="img-fluid" alt="Colorlib Template">
	    				</div>
	    				<div class="text">
	    				...
	    				<a href="images/h32.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="icon-expand"></span>
	    				</a>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-4 ftco-animate">
    				<div class="project">
    					<div class="img">
		    				<img src="images/h33.jpg" class="img-fluid" alt="Colorlib Template">
	    				</div>
	    				<div class="text">
	    				...
	    				<a href="images/h33.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="icon-expand"></span>
	    				</a>
    				</div>
    			</div>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">Borey Peng Hout, Chbar Apmov, Ohnom Penh, Cambodia</span></li>
	                <li ><a href="#"><span class="icon icon-phone"></span><span class="text"></span>+(855)98 833 994</a></li>
